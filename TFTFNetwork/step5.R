...
write.table(sign.pairs,file="/media/yuhua/yuhua_projects/enhProj/ENHData/enh_stage_group_files/GSR/tf_tf_motif_coregnetwork.txt",row.names=FALSE,col.names=TRUE,quote=FALSE)
...
tf.tf.pairs.gsr <- read.table(file="/media/yuhua/yuhua_projects/enhProj/ENHData/enh_stage_group_files/GSR/tf_tf_motif_coregnetwork.txt",header=TRUE,stringsAsFactors=FALSE)
...
tf.to.stage <- read.table(file="/media/yuhua/yuhua_projects/enhProj/ENHData/enh_stage_group_files/GSR/tfnames_to_stages.txt",header=FALSE,stringsAsFactors=FALSE)
...
toCytoscape(G = tf.tf.net.graph,file.name = '/media/yuhua/yuhua_projects/enhProj/ENHData/enh_stage_group_files/GSR/TF_TF_motif_coregnetwork.json')