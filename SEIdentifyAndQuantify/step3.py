...
df1 = pd.read_csv('/media/yuhua/yuhua_projects/enhProj/ENHData/SuperE3.csv',header = 0)

enh = df1[['chr','start','end','length']]
enh.index = list(range(1,len(enh)+1))

# enh_count0 = pd.read_csv("/media/yuhua/yuhua_projects/enhProj/ENHData/GSR.count.csv",index_col=0)
enh_count0 = pd.read_csv("/media/yuhua/yuhua_projects/enhProj/ENHData/XW.count.csv",index_col=0)
...
# enh_EPM.to_csv("/media/yuhua/yuhua_projects/enhProj/ENHData/GSR_EPM_SuperE3.csv")
enh_EPM.to_csv("/media/yuhua/yuhua_projects/enhProj/ENHData/XW_EPM_SuperE3.csv")
